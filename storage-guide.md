...
**NEVER touch the content of those chests when the system is currently active**
...
- **What does it sort?** Sorts stackable items inside chests and boxes and many non-stackable items using both an unstackable sorter and copper golems. 640 chest hall items, 80 accessible loaders, 14 MIS categories holding up to 54 item types each. It **can't** sort full shulker boxes without unloading them.
